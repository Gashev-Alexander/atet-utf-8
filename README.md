...
### Выполнение 
#### ([Скрипт](https://github.com/Gashev-Alexander/atet-utf-8/blob/main/delfiletodir.sh))
Создаем и открываем файл следующей командой (можно так же открыть в редакторе nano командой "nano delfiletodir"):
```
cat > delfiletodir
```
Прописываем текст, указанный ниже:
...
### Выполнение
#### ([Скрипт](https://github.com/Gashev-Alexander/atet-utf-8/blob/main/ownersort.sh))
...
```
Считываем владельцев и названия. (нечётное - владелец, чётное - название)
